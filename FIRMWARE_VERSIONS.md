...
| ESP32 satellite firmware | 2.10 | `shared/firmware_versions.h` (`SATELLITE_FW_VERSION_MAJOR`, `SATELLITE_FW_VERSION_MINOR`) | Uses SHT85 high-repeatability single-shot mode with CRC-validated readout and a low-duty sample-rate limit. |
